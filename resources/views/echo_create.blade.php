...
@section('content')
    <div class="container-fluid">
        ...
        <div class="block-header">
            <h2>UPLOAD NEW PRESBYTERIAN ECHO </h2>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form class="form-horizontal" 
                            ...
                            <div class="form-group">
                                <label for="telephone" class="col-sm-2 control-label">Month: </label>

                                <div class="col-sm-10">
                                    <div class="form-line">
                                        <select name="month" class="form-control show-tick" required>
